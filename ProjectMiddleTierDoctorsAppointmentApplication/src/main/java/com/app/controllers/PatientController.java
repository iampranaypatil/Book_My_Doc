...
//	JavaMailSender sender;
	...
	/*Patient p;
		...
		mailMsg.setSubject("Registration Details...");
		mailMsg.setText("Your registration has been done successfully in LifeLine Hospital.\n"
				+"Following are your Login details :\n"
				+ "UserId : " + p.getUser_id().getEmail()+"\n"
				+"Password : " + p.getUser_id().getPassword());
		sender.send(mailMsg);
		}
		catch(Exception e)
		{
