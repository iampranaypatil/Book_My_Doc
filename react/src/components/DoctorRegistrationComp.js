    ...
    return(
        ...
        <form action="">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="image" placeholder="Enter image" name="image" value={info.image}
                    ...
                    <div class="card" >
                      <div class="card-body p-5">
                        ...
                        <form action="">
                            ...
                            <div class="mb-3">
                                <label for="qualification" class="form-label">Qualification :</label>
                                <input type="text" class="form-control" id="qualification" placeholder="Enter qualification" name="qualification" value={info.qualification}
                                onChange={(e)=>{dispatch({type:'update',fld:'qualification',val:e.target.value})}}/>
                            </div>

                            <div class="mb-3">
                                <label for="specialization" class="form-label">Specialization :</label>
                                <input type="text" class="form-control" id="specialization" placeholder="Enter specialization" name="specialization" value={info.specialization}
                                onChange={(e)=>{dispatch({type:'update',fld:'specialization',val:e.target.value})}}/>
                            </div>

                            <div class="mb-3">
                                <label for="imr_no" class="form-label">IMR no :</label>
                                <input type="text" class="form-control" id="imr_no" placeholder="Enter imr_no" name="imr_no" value={info.imr_no}
                                onChange={(e)=>{dispatch({type:'update',fld:'imr_no',val:e.target.value})}}/>
                            </div>

                            <div class="mb-3">
                                <label for="department" class="form-label">Department :</label>
                                <input type="text" class="form-control" id="department" placeholder="Enter department" name="department" value={info.department}
                                onChange={(e)=>{dispatch({type:'update',fld:'department',val:e.target.value})}}/>
                            </div>

                            <div class="mb-3">
                                <label for="docType" class="form-label">Type :</label>
                                <input type="text" class="form-control" id="docType" placeholder="Enter type of doctor..." name="docType" value={info.type}
